...
export default class Main extends Component{
    ...
    fetchData=()=>{
        ...
        //서버주소 연결
        request.open('GET', 'http://mrhi2018.dothome.co.kr/index.js');
    ...
    fetchData2=()=>{
        ...
        // let name="sam";
        // let msg= "Hello world";
        // fetch(`http://mrhi2018.dothome.co.kr/php/getMethod.php?name=${name}&msg=${msg}`)
        // .then(response=>response.text())
        // .then(responseText=> this.setState({text: responseText}))
        // .catch(error=>alert(error));
        ...
        // fetch('http://mrhi2018.dothome.co.kr/php/postMethod.php', {
        //     method:'POST',
