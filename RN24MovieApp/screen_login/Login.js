        ...
        return (
            <View style={style.root}>                
                ...
                <View style={style.content}>
                    {/* <ImageBackground source={{uri:"https://image.freepik.com/free-vector/_1095-34.jpg"}} style={{width:'100%', height:'100%'}}></ImageBackground> */}
                    {/* <Image source={{uri:"https://image.freepik.com/free-vector/_1095-34.jpg"}} style={{flex:1, resizeMode:'cover'}}></Image> */}
                    {/* 1.1 로고 */}
                    <Text style={style.logo}>영화</Text>
                    ...
                    <TouchableOpacity style={style.touchPW} onPress={()=>{this.props.navigation.navigate('RestPW')}}>
                    <Text style={style.resetPW}>비밀번호 찾기</Text>
                    </TouchableOpacity>

                    {/* 1.4 로그인 버튼 */}
                    {/* 가로 전체 사이즈의 버튼을 만들기 위해 View로 감싸기 */}
                    <View style={{width:'100%', marginBottom:24,}}>
                        <Button color='#F15F5F' title="로그인" onPress={this.login}></Button>
                    </View> 
                ...
                <View style={style.footer}>
                    <Text style={style.footerCopyright}> MovieApp by min</Text>
                </View>
            </View>
        );
    }//render
