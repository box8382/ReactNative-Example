        ...
        return (
            <View style={style.root}>
                ...
                <View style={style.content}>
                    ...
                    {/* 1.4 전화번호 탭일때 다음 버튼 */}
                    {
                        this.state.tabIndex===0 && <View style={{width:'100%', margin:16}}><Button color="#F15F5F" title="다음" onPress={ ()=>this.setTabIndex(1) }></Button></View> 
                    }

                    {/* 1.5 이메일 탭일때 다음 버튼 */}
                    {
                        this.state.tabIndex===1 && <View style={{width:'100%', margin:16}}><Button color="#F15F5F" title="완료" onPress={ ()=>this.props.navigation.goBack() }></Button></View> 
                    }

                    {/* 1.6 전화번호 탭일때 안내메세지 */}
                    {
                        this.state.tabIndex===0 && <Text style={style.telMessage}>영화 앱의 업데이트 내용을 SMS로 수신할 수 있으며, 언제든지 수신을 취소할 수 있습니다.</Text>
                    }
